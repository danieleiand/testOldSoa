/*******************************************************************************
 * $Header: /opt/cvsroot/wiki/opensource/gocom/abframe2/src/org.gocom.abframe.tools/src/org/gocom/abframe/tools/ExcelTemplate.java,v 1.10 2010/12/07 03:10:10 caisy Exp $
 * $Revision: 1.10 $
 * $Date: 2010/12/07 03:10:10 $
 *
 *==============================================================================
 *
...
public class ExcelTemplate {
    ...
    */
     ...
     * @throws Exception
     */
    public int importData(String targetFile,String entityName,int submitCount,String userId,String userName)throws Exception{
        ...
        for(int sheetCount=0;sheetCount<wb.getNumberOfSheets();sheetCount++){
            ...
            for(int rowCount=startRow+2;rowCount<=rows;rowCount++){
            	...
            	//添加三个字段
            	importEntity.set("operator", userName);
            	importEntity.set("operatorcode", userId);
            	importEntity.set("lastoperatetime", new Date());
