...
package com.yd.soa.bpsyewumgr.gysjxyhtqd;
...
public class Pushtoyqb {
	 ...
	 */
	  ...
	  {  
	    ...
	    System.out.println("工业手机续用合同推送韵签宝开始--------------begin " + processInfo.getDate("processinstid"));
	    LogUtil.logInfo("YD_INTF", "工业手机续用合同推送韵签宝开始--------------begin ", null);
...
//		      postData.put("wdgqxx", array);
	      ...
	      LogUtil.logInfo("YD_INTF", "工业手机续用合同推送韵签宝{0}:返回消息{1}:【{2}】", null, processInfo,retData,postData.toJSONString());
	    ...
	    System.out.println("工业手机续用合同推送韵签宝结束--------------end ");
	    System.out.println(retData.toString());
	    LogUtil.logInfo("YD_INTF", "工业手机续用合同推送韵签宝结束--------------end ", null);
	    return retData;
	  }
