/*******************************************************************************
 * $Header: /opt/cvsroot/wiki/opensource/gocom/abframe2/src/org.gocom.abframe.tools/src/org/gocom/abframe/tools/ExcelUtil.java,v 1.7 2010/12/01 03:22:41 caisy Exp $
 * $Revision: 1.7 $
 * $Date: 2010/12/01 03:22:41 $
 *
 *==============================================================================
 *
...
public class ExcelUtil {
	...
	@Bizlet(
		...
		params = { 
	        ...
	        @BizletParam(index = 2, paramAlias = "userId",type=ParamType.VARIABLE),
	        @BizletParam(index = 3, paramAlias = "userName",type=ParamType.VARIABLE)
	   }
	)
	public static int importExcel(String excelFile,String entityFullName, String userId, String userName)throws Exception{
		ExcelTemplate template=new ExcelTemplate();
		return template.importData(excelFile, entityFullName, 500, userId, userName);
	}
