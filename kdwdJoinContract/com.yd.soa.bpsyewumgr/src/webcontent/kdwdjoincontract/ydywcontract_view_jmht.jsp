     ...
     <w:panel id="panel51" width="100%" title="特许加盟合同相关基础信息补全（加盟合规组填写）">  
		<table align="center" border="0" width="100%" class="form_table" id="form_table2">
			...
			<tr>
				<td class="form_label">合同有效期限</td>
				<td colspan="1" width="40%">
					<w:date id="yxdatefrom" property="viewobject/yxdatefrom" value="2022-06-01" />
					<font style="color: red">&nbsp;*</font>至
					<w:date id="yxzzdateto" property="viewobject/yxzzdateto" value="2025-05-31" />
				</td>
				<td class="form_label">商标许可使用期限</td>
				<td colspan="1" width="40%">
					<w:date id="sydatefrom" property="viewobject/sydatefrom" value="2022-06-01" />
					<font style="color: red">&nbsp;*</font>至
					<w:date id="syzzdateto" property="viewobject/syzzdateto" value="2025-05-31" />
				</td>
			</tr>
			
			<tr>
				<td class="form_label">其他补充约定</td>
				<td colspan="1" width="40%"><h:text property="viewobject/remark" style="width:500px" />
					<font style="color: red">&nbsp;*</font></td>
