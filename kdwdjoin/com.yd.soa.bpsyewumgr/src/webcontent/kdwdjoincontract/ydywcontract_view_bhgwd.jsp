    ...
    <w:panel id="panel_contract_history" titleStyle="font-weight: bold;color: black;" width="100%" title="网点证照基础信息">
       <table align="center" border="0" width="100%" class="EOS_table">
       		<tr>
				...
				<td colspan="1" width="40%"><h:text property="viewobject/tyshxycode" style="width:300px" validateAttr="allowNull=false"/></td>
			</tr>
			<tr>
     ...
     <w:panel id="panel52" width="100%" title="网点合作协议相关基础信息补全（加盟合规组填写）">  
		<table align="center" border="0" width="100%" class="form_table" id="form_table2">
			...
			<tr>
				<td class="form_label">合同有效期限</td>
				<td colspan="1" width="40%">
					<w:date id="yxdatefrom1" property="viewobject/yxdatefrom"  value="2026-03-01"/>
					<font style="color: red">&nbsp;*</font>至
					<w:date id="yxzzdateto1" property="viewobject/yxzzdateto" value="2029-02-28" />
				</td>
