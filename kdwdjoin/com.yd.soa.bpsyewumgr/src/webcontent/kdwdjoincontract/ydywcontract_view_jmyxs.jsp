...
<h:css href="/common/comm_style.css"/>
  ...
  <body>
    ...
    <w:panel id="panel_contract_history" titleStyle="font-weight: bold;color: black;" width="100%" title="网点证照基础信息">
       <table align="center" border="0" width="100%" class="EOS_table">
       		<tr>
				...
				<td colspan="1" width="50%"><h:text property="viewobject/yyzzname" style="width:300px"/></td>
			...
			<tr>
				...
				<td colspan="1" width="50%"><h:text property="viewobject/zcaddress" style="width:300px"/></td>
			...
			<tr id="kdywjyxkz">
				...
				<td colspan="1" width="30%"><h:text property="viewobject/kdywjyxkz" style="width:300px"/></td>
			...
			<tr>
				...
				<td colspan="1" width="30%"><h:text property="viewobject/wdsjjyaddress" style="width:300px"/></td>
	...
	<div id="qwer" style="position:relative">
     <w:panel id="panel53" width="100%" title="加盟意向书相关基础信息补全（加盟合规组填写）">  
		<table align="center" border="0" width="100%" class="form_table" id="form_table2">
			<tr>
				<td class="form_label">加盟意向书有效期限</td>
				<td colspan="1" width="40%">
					<w:date id="yxdatefrom2" property="viewobject/yxdatefrom" />
					<font style="color: red">&nbsp;*</font>至
					<w:date id="yxzzdateto2" property="viewobject/yxzzdateto" />
				</td>
				<td class="form_label"></td>
				<td colspan="1" width="40%"></td>
			</tr>
