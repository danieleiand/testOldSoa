...
{"getNSValue('store1')": {
  ...
  "xtype": "servicestore",
  "listeners": {"onLoadSuccess": function onLoadSuccess( records , options ){
...
window2.close();
	...
	var window2, commongrid1, button2, button3, commongrid1_widgetName, checkboxSelectionModel1, textfield1;
